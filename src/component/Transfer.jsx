  ...
  return (
    <div className=' h-[12.7rem] bg-[#FFF] p-3 rounded-[0.6rem]'>
                ...
                <div className='flex flex-row justify-between pl-3 pr-3 pt-3 items-center'>
                    <h4 className='text-sm text-[#4F64A7] font-nunito'>Total transfer</h4>
                ...
                <div className='flex flex-row gap-10 justify-between ml-4 mt-6 mr-4'>
                    ...
                    <div>
                        ...
                        <h4 className='font-semibold text-[#032282] font-sora'>₦500</h4>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <h4 className='font-semibold  text-[#032282] font-sora'>₦200</h4>
                    </div>
                    <div>
