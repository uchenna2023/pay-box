  ...
  return (
    <div className=' h-[12.7rem] bg-[#FFF] p-3 rounded-[.6rem]'>
                ...
                <div className='flex flex-row justify-between pl-3 pr-3 pt-3 items-center'>
                    <h4 className='text-sm text-[#4F64A7] font-nunito'>Average Commission Per Transaction</h4>
                ...
                <div className='flex flex-row gap-20 justify-between mr-4 ml-4 mt-6'>
                    <div>
                    <div>
                        <p className='text-xs text-[#4F64A7] font-nunito'>Value</p>
                        <h4 className='font-bold text-[#032282] font-sora'>₦20,400</h4>
                    </div>
                    </div>
                    <div>
                    <div>
                        <p className='text-xs text-[#4F64A7] font-nunito'>Count</p>
