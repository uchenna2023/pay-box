...
const Savings = () => {
  return (
    <div className=' h-[9.4rem] bg-[#FFF] pl-3 pr-3 rounded-xl'>
                ...
                <p className='pt-6 ml-4 text-sm font-nunito'>Total saving balance</p>
                <h2 className='text-[#032282] text-xl font-extrabold mt-5 ml-4 font-sora'>₦194,000</h2>

                </div>
                <div className='flex flex-row mt-2'>
                <p className='ml-7 text-xs font-nunito'>View details</p>
                <div className='flex flex-row relative'>
                    <svg className='absolute left-2' xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    ...
                    <svg className='absolute left-1'xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    <path fillRule="evenodd" clipRule="evenodd" d="M11.8112 7.4519C13.0193 8.6788 13.0595 10.6426 11.932 11.9186L11.8112 12.0481L8.51569 15.1995C8.20327 15.5168 7.69674 15.5168 7.38432 15.1995C7.09594 14.9066 7.07375 14.4458 7.31777 14.127L7.38432 14.0505L10.6799 10.899C11.2718 10.2978 11.303 9.34277 10.7733 8.70431L10.6799 8.60095L7.38432 5.44952C7.0719 5.13222 7.0719 4.61778 7.38432 4.30048C7.67271 4.00758 8.1265 3.98505 8.44033 4.23288L8.51569 4.30048L11.8112 7.4519Z" fill="#bae6fd"/>
                    </svg>
                </div>
                </div>
            </div>
